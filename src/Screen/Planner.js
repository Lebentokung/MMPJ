    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        <View style={styles.segControl}>
          <TouchableOpacity style={[styles.segBtn, viewMode === 'classes' && styles.segActive]} onPress={() => setViewMode('classes')}><Text style={viewMode === 'classes' ? { fontWeight: '700',color:'#fff' } : {}}>{'Activities'}</Text></TouchableOpacity>
          <TouchableOpacity style={[styles.segBtn, viewMode === 'study' && styles.segActive]} onPress={() => setViewMode('study')}><Text style={viewMode === 'study' ? { fontWeight: '700',color:'#fff' } : {}}>{'Study'}</Text></TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    marginTop: 32,marginBottom: 16, fontSize: 18, fontWeight: '700', textAlign: 'center'},
  ...
  , card: { flexDirection: 'row', justifyContent: 'space-between', padding: 12, borderWidth: 1, borderColor: '#eee', borderRadius: 8, marginVertical: 3, backgroundColor: '#f0dff0',elevation:1 }
